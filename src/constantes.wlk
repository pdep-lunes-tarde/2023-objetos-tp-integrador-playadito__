...
////////////////////////////// MENSAJES /////////////////////////////////
const imagenPasoDeManoJugador = new Mensaje(imagen = "assets/message-pasarManoJugador.png")

const imagenPasoDeManoRival = new Mensaje(imagen = "assets/message-pasarManoRival.png")
