...
const filaDescartadosJugador = new FilaCartasDescartadas(posEnX = 147, posEnY = 30, posEnYCarta = 31)

const filaDescartadosRival = new FilaCartasDescartadas(posEnX = 147, posEnY = 68, posEnYCarta = 69)
